...
/*waypoints is used to handle scroll events*/
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function createWaypoints() {
            ...
            this.itemsToReveal.each(function () {
                /*the 'each' function will help to create 4 waypoints for the 4 featured items*/
...
var StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        value: function refreshWaypoints() {
            /*This will help to ensure the header links do not highlight too early before raching the section*/
        ...
        value: function createHeaderWaypoint() {
            var that = this;
            new Waypoint({
                element: this.headerTriggerElement[0], /*to access JS native DOM element within jquery object use [0]*/
